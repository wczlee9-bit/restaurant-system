...
class ConnectionManager:
    ...
    def disconnect(self, store_id: int = None, order_id: int = None, connection_id: str = None):
        """断开连接"""
...
async def websocket_store(
    ...
    try:
        ...
        logger.info(f"店铺WebSocket断开: store_id={store_id}, connection_id={connection_id}")
    except Exception as e:
...
async def websocket_order(
    ...
    try:
        ...
        logger.info(f"订单WebSocket断开: order_id={order_id}, connection_id={connection_id}")
    except Exception as e:
