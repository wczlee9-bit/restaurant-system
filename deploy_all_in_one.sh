...
###############################################################################
# 腾讯云一键部署脚本
# 作用：从 Gitee 克隆代码并部署到腾讯云服务器
# 使用：bash deploy_all_in_one.sh
###############################################################################
...
# 配置变量
GITEE_REPO="${GITEE_REPO:-https://gitee.com/lijun75/restaurant.git}"
...
clone_code() {
    print_header "步骤 3：从 Gitee 克隆代码"
